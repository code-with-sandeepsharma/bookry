  ...
  return (
    <>
      ...
      <div className="border-b border-slate-200 ">
        <div className="mx-auto grid w-full max-w-full grid-cols-4 gap-6 py-2 px-6 text-sm bg-blue-800 text-slate-500 md:grid-cols-8 lg:max-w-5xl lg:grid-cols-12 xl:max-w-7xl 2xl:max-w-[96rem]">
          ...
          <div className="col-span-2 items-center justify-end gap-6 md:col-span-4 lg:col-span-6 bg-red">
            <div className="flex items-center justify-end gap-4 bg-red">
            
              <a
                href="javascript:void(0)"
                className="transition-colors duration-300 hover:text-emerald-500 bg-red"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
      ...
      <header className="border-b-1 relative z-20 w-full  border-b border-slate-200  shadow-lg shadow-slate-700/5 after:absolute after:top-full after:left-0 after:z-10 after:block after:h-px after:w-full after:bg-slate-200 lg:border-slate-200 lg:backdrop-blur-sm lg:after:hidden">
        <div className="relative mx-auto max-w-full bg-slate-500 px-6 lg:max-w-5xl xl:max-w-7xl 2xl:max-w-[96rem]">
          <nav
          ...
          >
            ...
            >
             <img src="/src/image/bg2.jpeg" className="w-10 h-10"></img>
              Bookry
              </a>
